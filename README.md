...
#### A chess like console application
...
## Description
_How it works: User enters X and Y coordinates for both a Queen and another piece and application determines whether the Queen is capable of attacking the other chess piece._
